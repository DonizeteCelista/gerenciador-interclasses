      ...
      .forEach(g=>{
        ...
        card.innerHTML=`
          ...
          <div class="bracket-team ${winner?.id===g.casaId?"winner":g.encerrado&&winner&&!direct?"loser":""}">
            <span>${esc(g.casa)}</span><strong>${!direct&&g.encerrado?displayedSetScore(g,"casa"):""}</strong>
          </div>
          <div class="bracket-team ${winner?.id===g.foraId?"winner":g.encerrado&&winner&&!direct?"loser":""}">
            <span>${esc(g.fora)}</span><strong>${!direct&&g.encerrado?displayedSetScore(g,"fora"):""}</strong>
          </div>
